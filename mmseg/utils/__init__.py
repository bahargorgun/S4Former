...
__all__ = [
    ...
    'generate_unsup_patchcutout_data', 'generate_sup_cutmix_data', 'generate_unsup_classmix_data', 'generate_unsup_cutmix_data_unimatch', 'generate_sup_classmix_data', 'generate_mix_with_labeled_data', 'generate_unsup_patchmix_data',
