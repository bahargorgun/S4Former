...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            ...
            split='data/BraTS2023/splits/new_1over16_supervised.txt',
            pipeline=train_pipeline,
        ),
        unsup=dict(
            type=dataset_type,
            data_root=train_data_root,
            split='data/BraTS2023/splits/new_1over16_unsupervised.txt',
            pipeline=train_pipeline,
        ),
    ),
    val=dict(
        ...
        split='data/BraTS2023/splits/val.txt',
...
model = dict(
    ...
    class_thresholds={0: 0.95, 1: 0.75, 2: 0.8, 3: 0.7},
)
